export const fetchArtworkData = async () => {
    try {
        const response = await fetch(`${process.env.REACT_APP_API_SERVER}/api/artwork`);
...
export const fetchArtworkDetailData = async (id) => {
    try {
        ...
        const response = await fetch(`${process.env.REACT_APP_API_SERVER}/api/artwork/${id}`);
        const data = (await response).json();
        console.log(data);
        return data;
    } catch (e) {
...
export const fetchCarouselData = async () => {
    try {
        const response = await fetch(`${process.env.REACT_APP_API_SERVER}/api/carousel/1`);
        const data = (await response).json();
        console.log(data);
        return data;
    } catch (e) {
